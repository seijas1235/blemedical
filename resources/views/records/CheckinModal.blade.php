          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-sm-3">
                    ...
                    <select class="form-control" name="vehicle_registration_type_id" id="vehicle_registration_type_id_in">
                    </select>
                </div>
                <div class="col-sm-8">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" id="ButtonVehicleinModal" >Agregar</button>
            </div>
          </div>
        </div>
    {!! Form::close() !!}
