...
<div class="modal fade" id="modalres" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    {!! Form::open( array( 'id' => 'VehicleresForm' ) ) !!}

      <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel">Agregar Vehiculo Residente</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="col-sm-3">
                    ...
                    <select class="form-control" name="vehicle_registration_type_id" id="vehicle_registration_type_idres">
                    </select>
                </div>
                <div class="col-sm-8">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" id="ButtonVehicleResModal" >Agregar</button>
            </div>
          </div>
        </div>
    {!! Form::close() !!}
