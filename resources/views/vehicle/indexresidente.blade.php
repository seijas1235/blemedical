...
@section('content_header')
    <h1>listado de vehiculos residentes</h1>
@stop
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-4 d-flex justify-content-end">
                            ...
                            {!! Form::submit('Crear nuevo', ['class'=>'btn btn-primary','id'=>'vres'])  !!}
                ...
                <table class="table table-striped table-bordered no-margin-bottom dt-responsive nowrap" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{route('vehicle.show',$recidente->id)}}"><i class='fa fa-solid fa-binoculars' title='ver'></i></a></td>
